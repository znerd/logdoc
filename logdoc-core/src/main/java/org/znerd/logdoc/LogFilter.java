 ...
 * <p>
 * A typical use is to filter out passwords so these will not be stored in a logging store.
 */
public abstract class LogFilter {
     ...
     * @throws IllegalArgumentException if <code>logger == null || param == null</code>.
     */
    public abstract String filter(String logger, String param, String value) throws IllegalArgumentException;
     ...
     * @throws IllegalArgumentException if <code>logger == null || param == null</code>.
     */
    public abstract Object filter(String logger, String param, Object value) throws IllegalArgumentException;
}
